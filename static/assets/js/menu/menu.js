        ...
        success: function (permissions) {
            ...
            $.each(permissions.data, function (i, permission) {
                content += "<tr data-tt-id='" + permission.id + "' data-tt-parent-id='" + permission.parentId + "'>"
                    ...
                    + "<td><button class=' btn btn-warning ' onclick='editPermission(" + permission.id + ")'><i class='fa fa-pencil-square-o'></i>编辑</button>&nbsp;&nbsp;&nbsp;&nbsp;" +
                    "<button class=' btn btn-danger' onclick='delPermission(" + permission.id + ")'><i class='fa fa-trash-o'></i>删除</button>" +
                    "</td></tr>";
...
$("#refresh-menu").click(function () {
    loadPages('/pages/menu/menuList.html')
});
