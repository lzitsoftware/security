...
$(function () {
    ...
    table = $("#table").dataTable({
        ...
        ajax: function (data, callback, settings) {
            ...
            $.ajax({
                type: "get",
                url: "http://localhost:8060/sys/admin/role/allRoleByPage",
                cache: false,  //禁用缓存
                data: param,  //传入组装的参数
                headers: {"token": token},
                success: function (result) {
    ...
    if (username == "") {
        ...
        table = $("#table").dataTable({
            ...
            ajax: function (data, callback, settings) {
                ...
                $.ajax({
                    type: "GET",
                    url: "http://localhost:8060/sys/admin/user/search/" + username,
                    cache: false,  //禁用缓存
                    data: param,  //传入组装的参数
                    headers: {"token": token},
                    success: function (result) {
...
function del(id) {
    ...
    if (r == true) {
        $.ajax({
            url: "http://localhost:8060/sys/admin/user/deleteUser/" + id,
            type: "DELETE",
            data: {"id": id},
            headers: {"token": token},
            success: function (data) {
...
$("#addUser").click(function () {
    ...
    $.ajax({
        type: "post",
        url: "http://localhost:8060/sys/admin/user/addUser",
        data: {
...
function edit(id) {
    $.ajax({
        type: "get",
        url: "http://localhost:8060/sys/admin/role/getSingleRole/" + id,
        headers: {"token": token},
        success: function (data) {
...
$("#editUser").click(function () {
    ...
    $.ajax({
        type: "post",
        url: "http://localhost:8060/sys/admin/user/updateUser/" + id,
        data: {
